...
DefaultDirName={commonpf}\Wownero App
DefaultGroupName=Wownero App
...
LicenseFile=LICENSE
AppPublisher=The Wownero Developer Community
AppPublisherURL=https://wownero.org
TimeStampsInUTC=yes
...
; Background info:
; This installer indeed asks for admin rights so the Wownero files can be copied to a place where they have at least
...
; applications somehow. Luckily this is no issue here because ALL files are "private" to Wownero.

Source: {#file AddBackslash(SourcePath) + "ReadMe.htm"}; DestDir: "{app}"; DestName: "ReadMe.htm"; Flags: ignoreversion
Source: "FinishImage.bmp"; Flags: dontcopy
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion

; wownero GUI wallet exe and guide
Source: "bin\wownero-app.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\wownero-gui-wallet-guide.pdf"; DestDir: "{app}"; Flags: ignoreversion

; wownero CLI wallet
Source: "bin\extras\wownero-wallet-cli.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-gen-trusted-multisig.exe"; DestDir: "{app}"; Flags: ignoreversion

; wownero wallet RPC interface implementation
Source: "bin\extras\wownero-wallet-rpc.exe"; DestDir: "{app}"; Flags: ignoreversion

; wownero daemon
Source: "bin\wownerod.exe"; DestDir: "{app}"; Flags: ignoreversion

; wownero daemon wrapped in a batch file that stops before the text window closes, to see any error messages
Source: "wownero-daemon.bat"; DestDir: "{app}"; Flags: ignoreversion;

; wownero blockchain utilities
Source: "bin\extras\wownero-blockchain-export.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-blockchain-mark-spent-outputs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-blockchain-usage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-blockchain-import.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-blockchain-ancestry.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-blockchain-depth.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-blockchain-prune-known-spent-data.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-blockchain-prune.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-blockchain-stats.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "bin\extras\wownero-gen-ssl-cert.exe"; DestDir: "{app}"; Flags: ignoreversion
...
begin
  ...
  blockChainDefaultDir := ExpandConstant('{commonappdata}\wownero');
  s := 'The default folder to store the Wownero blockchain is ' + blockChainDefaultDir;
  s := s + '. As this will need more than 2 GB of free space, you may not need to use a folder on a different drive.';
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\wownero-project\wownero-core', 'blockchainDataDir', blockChainDir);
...
begin
  Result := BlockChainDir('') + '\wownero.log';
...
begin
  if CurStep = ssPostInstall then begin
    // Re-build "wownero-daemon.bat" according to actual install and blockchain directory used
    SetArrayLength(s, 3);
    s[0] := 'REM Execute the Wownero daemon and then stay with window open after it exits';
    s[1] := '"' + ExpandConstant('{app}\monerod.exe') + '" ' + DaemonFlags('');
    s[2] := 'PAUSE';
    SaveStringsToFile(ExpandConstant('{app}\wownero-daemon.bat'), s, false); 
  end;
end;
...
[Icons]
; Icons in the "wownero GUI Wallet" program group
; Windows will almost always display icons in alphabetical order, per level, so specify the text accordingly
Name: "{group}\GUI Wallet"; Filename: "{app}\wownero-app.exe";
Name: "{group}\GUI Wallet Guide"; Filename: "{app}\wownero-gui-wallet-guide.pdf"; IconFilename: "{app}\wownero-app.exe"
...
Name: "{group}\Utilities\wownero Daemon"; Filename: "{app}\monerod.exe"; Parameters: {code:DaemonFlags}
...
Name: "{group}\Utilities\Textual (CLI) Wallet"; Filename: "{app}\wownero-wallet-cli.exe"; WorkingDir: "{userdocs}\wownero\wallets"
...
Name: "{group}\Utilities\x (Check Default Wallet Folder)"; Filename: "{win}\Explorer.exe"; Parameters: """{userdocs}\wownero\wallets"""
Name: "{group}\Utilities\x (Check GUI Wallet Log)"; Filename: "Notepad"; Parameters: """{userappdata}\wownero-app\wownero-app.log"""
Name: "{group}\Utilities\x (Try Daemon, Exit Confirm)"; Filename: "{app}\wownero-daemon.bat"
...
Root: HKCU; Subkey: "Software\wownero-project"; Flags: uninsdeletekeyifempty
Root: HKCU; Subkey: "Software\wownero-project\wownero-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\wownero-project\wownero-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};

; Configure a custom URI scheme: Links starting with "wownero:" will start the GUI wallet exe with the URI as command-line parameter
; Used to easily start payments; example URI: "wownero://<address>?tx_amount=5.0"
Root: HKCR; Subkey: "wownero"; ValueType: "string"; ValueData: "URL:wownero Payment Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "wownero"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "wownero\DefaultIcon"; ValueType: "string"; ValueData: "{app}\wownero-app.exe,0"
Root: HKCR; Subkey: "wownero\shell\open\command"; ValueType: "string"; ValueData: """{app}\wownero-app.exe"" ""%1"""
...
Root: HKCR; Subkey: "wowneroseed"; ValueType: "string"; ValueData: "URL:wownero Seed Node Protocol"; Flags: uninsdeletekey
Root: HKCR; Subkey: "wowneroseed"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "wowneroseed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\wownero-app.exe,0"
Root: HKCR; Subkey: "wowneroseed\shell\open\command"; ValueType: "string"; ValueData: """{app}\wownero-app.exe"" ""%1"""